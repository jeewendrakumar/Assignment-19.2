        ...
        return (
            <div className="book-drawer">
                ...
                <form className="add-book form" onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-group">
                        <button type="button" className="btn cancel" onClick={this.closeBookDrawer}>Cancel</button>
                        <button type="submit" className="btn btn-primary  float-right submit">Add Book</button>
                    </div>
                </form>
            </div>
        );
